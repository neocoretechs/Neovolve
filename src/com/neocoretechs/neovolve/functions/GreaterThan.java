...
public class GreaterThan extends Function implements Serializable {
  ...
  public boolean execute_boolean(Chromosome c, int n, Object[] args) {
    if (childType.equals(integerClass))
      ...
      return ((Compatible)c.execute_object(n, 0, args)).greater_than(c.execute_object(n, 1, args));
    throw new UnsupportedOperationException(
    	"GreaterThan may not take a void argument");
  }
  ...
  public static interface Compatible {
    public boolean greater_than(Object o);
  }
}