 ...
 * @author Groff 1/2003
 */
public class Contains extends Function implements Serializable {
   Class childArg1, childArg2;
  /**
   * Creates a contains node of the given type, always returning boolean
   * CNTNS(mainthing thinglookingfor)
   * @param childArg1 The type of first arg to function, because we're generic indexOf
   * @param childArg2        "    second   "
   */
  public Contains(Class childArg1, Class childArg2) {
  ...
  public boolean execute_boolean(Chromosome c, int n, Object[] args) {
    ...
    return ((Compatible)c.execute_object(n, 0, args)).execute_contains(targ);
  }
  ...
  public static interface Compatible {
    public boolean execute_contains(Object t);
  }
